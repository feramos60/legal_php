...
class Auth
{
    /**
     * Login the user
     * EN $_SESSION nos quedan id, user_name,
     * role_id, y club_id del usuario
     *
    ...
    {
        $cookie = $_COOKIE['remember_me'] ?? false;  //verifica si existe la variable y si no existe la vuelve FALSE
